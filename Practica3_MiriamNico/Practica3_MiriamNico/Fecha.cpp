...
void Fecha::castingFecha(string cadena) {
	anio = std::stoi(cadena.substr(0, 4));
	mes = std::stoi(cadena.substr(4, 2));
	dia = std::stoi(cadena.substr(6, 2));
	hora = std::stoi(cadena.substr(8, 2));
	min = std::stoi(cadena.substr(10, 2));
	seg = std::stoi(cadena.substr(12, 2));
}
