...
void Fecha::pasarAFecha(string marcaT){
	...
	anio = std::stoi(marcaT.substr(0, 4));
	mes = std::stoi(marcaT.substr(4, 2));
	dia = std::stoi(marcaT.substr(6, 2));
	hora = std::stoi(marcaT.substr(8, 2));
	minuto = std::stoi(marcaT.substr(10, 2));
	segundo = std::stoi(marcaT.substr(12, 2));
}